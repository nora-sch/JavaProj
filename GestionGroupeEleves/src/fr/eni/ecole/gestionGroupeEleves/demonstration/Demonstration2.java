package fr.eni.ecole.gestionGroupeEleves.demonstration;
...
public class Demonstration2 {
	...
	/**
	 * Départ d'un éléve en le recherchant dans les éléves de la classe et le
	 * supprimant de la classe
	 */
	public static void departDUnEleve() {
		...
		try {
			...
			System.out.println("\n---------------------------------------------------");
			System.out.println("DEPART DE " + e.getPrenom() + " " + e.getNom() + " de la classe verte");
